...
public class ClinicaDetalhe extends AppCompatActivity implements com.petsaude.util.calendario.CalendarView.OnDispatchDateSelectListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        final Spinner vaga = (Spinner) findViewById(R.id.selecao_vaga);
        ...
        consulta.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                //vagaNegocio.updateVaga(Session.getUsuarioLogado(), animais.getSelectedItemId(), vaga.getSelectedItemId());
                //Toast.makeText(ClinicaDetalhe.this,Session.getUsuarioLogado().getId()+"-"+animais.getSelectedItemId()+"-"+vaga.getSelectedItemId(), Toast.LENGTH_SHORT).show();
            }
        });
